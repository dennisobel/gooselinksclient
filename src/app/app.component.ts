...
export class MyApp {
  ...
  constructor(public platform: Platform, public statusBar: StatusBar, public splashScreen: SplashScreen) {
    ...
    this.pages = [
      { title: 'Subscribed', component: SubscribedPage, icon:'logo-rss' },
      { title: 'Profile', component: ProfilePage, icon:'md-contact' },
      { title: 'Friends', component: GiftfriendsPage, icon: 'md-contacts' },
      { title: 'Contact Us', component: ContactPage, icon: 'md-call'},      
    ];
